...
public class ProductService {
    ...
    public Product findById(Long id) {
        Long safeId = Objects.requireNonNull(id, "El id del producto no puede ser null");
    ...
    public Product save(Product product) {
        Product safeProduct = Objects.requireNonNull(product, "El producto no puede ser null");
